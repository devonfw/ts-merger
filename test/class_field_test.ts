...
describe('Merging class fields', () => {
  ...
  describe('should add the field from', () => {
    ...
    const base = `class a { private b; }`, patch = `class a { private c; }`;
  ...
  describe('should use the value from', () => {
    ...
    const base = `class a { private b = 1; }`, patch = `class a { private b = 2; }`;
  ...
  describe('should use the modifier from', () => {
    ...
    const base = `class a { private b; }`, patch = `class a { public b; }`;
